...
$page_title = "Vendor Notifications";
$path_prefix = '../';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'mark_all_read') {
    $pdo->prepare("UPDATE notifications SET is_read = 1 WHERE user_type = 'vendor' AND user_id = :vendor_id")->execute([':vendor_id' => $vendorId]);
    set_flash('success', 'All vendor notifications marked as read.');
    header("Location: notifications.php");
    exit();
}

// Fetch vendor notifications
$stmt = $pdo->prepare("SELECT * FROM notifications WHERE user_type = 'vendor' AND user_id = :vendor_id ORDER BY created_at DESC");
    ...
    <div class="dashboard-main-wrapper">
        ...
        <main class="dashboard-content-area">
            ...
            <div class="page-header-row">
                <div>
                    <h1 class="page-title-text">Vendor Alerts & Notifications</h1>
                    <p class="page-subtitle-text">Incoming client rental bookings, approval notifications, and store alerts.</p>
                </div>
                <div>
            ...
            <div class="dashboard-card" style="padding: 20px;">
                ...
                <?php else: ?>
                    <div class="text-center" style="padding: 50px 20px;">
                        ...
                        <p class="text-muted" style="font-size: 0.92rem;">Your boutique is all caught up! New rental requests will appear here.</p>
                    </div>
                <?php endif; ?>
            </div>
        </main>
